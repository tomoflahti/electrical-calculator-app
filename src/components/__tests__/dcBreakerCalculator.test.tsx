...
describe('DC Breaker Calculator', () => {
  ...
  describe('Component Rendering', () => {
    it('should render the DC Breaker Calculator with title and description', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText('DC Circuit Breaker Calculator')).toBeInTheDocument();
      });

      expect(screen.getByText(/Calculate circuit breaker sizing for DC electrical systems/)).toBeInTheDocument();
    });
  ...
  describe('Form Inputs and Validation', () => {
    it('should have default values', async () => {
      ...
      const continuousSwitch = screen.getByRole('checkbox', { name: /continuous operation/i });
    ...
    it('should show solar-specific inputs when solar application is selected', async () => {
      ...
      expect(screen.queryByText('Short Circuit Current (A)')).not.toBeInTheDocument();
  ...
  describe('Calculation Functionality', () => {
    it('should perform calculation when button is clicked', async () => {
      const { calculateDCBreakerSize } = require('../../utils/calculations/dcBreakerRouter');
    ...
    it('should show compliance indicators', async () => {
      ...
      await waitFor(() => {
        ...
        expect(screen.getByText('Base current (20A) × Safety factor (1.25)')).toBeInTheDocument();
      }, { timeout: 3000 });
    });
  });
