...
describe('DC Wire Calculator Standard Selection', () => {
  ...
  describe('Default Behavior', () => {
    it('should default to automotive application and DC_AUTOMOTIVE standard', async () => {
      ...
      expect(screen.getByText('12V/24V automotive electrical systems with ISO 6722 compliance')).toBeInTheDocument();
    });
  ...
  describe('Application Selection', () => {
    ...
    it('should show calculator supports multiple application types', async () => {
      ...
      expect(screen.getByText(/automotive, marine, solar, and telecommunications applications/)).toBeInTheDocument();
    });
  ...
  describe('Application-Specific Features', () => {
    ...
    it('should show automotive guidance by default', async () => {
      ...
      expect(screen.getByText('Automotive System Guidelines')).toBeInTheDocument();
      expect(screen.getByText(/Automotive systems require strict voltage drop limits/)).toBeInTheDocument();
    });
  });
