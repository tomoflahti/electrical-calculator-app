...
describe('ConduitFillChart', () => {
  ...
  describe('Data Display Tests', () => {
    ...
    it('should render pie chart view when selected', () => {
      ...
      const selectElement = container.querySelector('[aria-labelledby*="Chart Type"]');
      expect(selectElement || screen.getByTestId('responsive-container')).toBeInTheDocument();
    });
  ...
  describe('IEC Standards Separation', () => {
    it('should use only IEC conduit calculations', () => {
      const { generateConduitFillComparisonData } = require('../../../utils/calculations/iecConduitFill');
