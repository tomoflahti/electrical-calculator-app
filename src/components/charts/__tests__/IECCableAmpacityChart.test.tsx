  ...
  IEC_ALUMINUM_CABLE_CROSS_SECTIONS: [
    {
      size: "16",
      crossSectionMm2: 16,
      currentCapacity70C: 59,
      currentCapacity90C: 73,
      resistance: 1.91,
      reactance: 0.09,
    },
    {
      size: "25",
      crossSectionMm2: 25,
      currentCapacity70C: 78,
      currentCapacity90C: 96,
      resistance: 1.2,
      reactance: 0.09,
    },
  ],
  IEC_TEMPERATURE_CORRECTION_FACTORS: {
    70: { 20: 1.12, 25: 1.06, 30: 1.0, 35: 0.94, 40: 0.87 },
    90: { 20: 1.08, 25: 1.04, 30: 1.0, 35: 0.96, 40: 0.91 },
  },
...
describe("IECCableAmpacityChart", () => {
  ...
  describe("IEC Standards Compliance", () => {
    it("should use copper cable data for copper material", () => {
      ...
      expect(
        screen.getByText(/IEC Cable Ampacity.*Copper/),
      ).toBeInTheDocument();
    });
    ...
    it("should use aluminum cable data for aluminum material", () => {
      ...
      expect(
        screen.getByText(/IEC Cable Ampacity.*Aluminum/),
      ).toBeInTheDocument();
    });
  ...
  describe("Summary Statistics", () => {
    it("should display summary statistics", () => {
      ...
      expect(
        screen.getByText(/cables.*Average derating.*Capacity range/),
      ).toBeInTheDocument();
    });
  ...
  describe("Derating Factors Display", () => {
    it("should display installation method factor", () => {
      ...
      expect(
        screen.getByText("Single cable clipped direct"),
      ).toBeInTheDocument();
    });
