...
jest.mock("../../../standards/nec/wireTables", () => ({
  ...
  NEC_TEMPERATURE_CORRECTION_FACTORS: {
    60: { 30: 1.0, 35: 0.94, 40: 0.82, 45: 0.71, 50: 0.58 },
    75: { 30: 1.0, 35: 0.94, 40: 0.88, 45: 0.82, 50: 0.75 },
    90: { 30: 1.0, 35: 0.96, 40: 0.91, 45: 0.87, 50: 0.82 },
  },
...
describe("NECWireAmpacityChart", () => {
  describe("Component Rendering", () => {
    ...
    it("should display chart title and description", () => {
      ...
      expect(
        screen.getByText(/NEC Wire Ampacity - Copper Conductors/),
      ).toBeInTheDocument();
      expect(
        screen.getByText(/Current carrying capacity adjusted for/),
      ).toBeInTheDocument();
    });
  ...
  describe("Material Properties", () => {
    ...
    it("should handle aluminum material", () => {
      ...
      expect(
        screen.getByText(/NEC Wire Ampacity - Aluminum Conductors/),
      ).toBeInTheDocument();
    });
  ...
  describe("Derating Factors", () => {
    it("should display applied derating factors", () => {
      ...
      expect(
        screen.getByText("Applied NEC Derating Factors"),
      ).toBeInTheDocument();
    ...
    it("should show correct bundling factor for 3 conductors", () => {
      ...
      expect(
        screen.getByText("3 conductors (NEC 310.15(B)(3)(a))"),
      ).toBeInTheDocument();
    });
    ...
    it("should show correct temperature factor for 30°C", () => {
      ...
      expect(
        screen.getByText("30°C ambient (NEC 310.15(B)(2)(a))"),
      ).toBeInTheDocument();
    });
  });
  ...
  describe("Insulation Information", () => {
    it("should display THHN insulation information", () => {
      ...
      expect(
        screen.getByText("THHN Insulation Specifications"),
      ).toBeInTheDocument();
      expect(
        screen.getByText("Thermoplastic High Heat-resistant Nylon-coated"),
      ).toBeInTheDocument();
    ...
    it("should display THWN insulation information", () => {
      ...
      expect(
        screen.getByText("THWN Insulation Specifications"),
      ).toBeInTheDocument();
      expect(
        screen.getByText("Thermoplastic Heat and Water-resistant Nylon-coated"),
      ).toBeInTheDocument();
  ...
  describe("Error Handling", () => {
    it("should handle missing insulation type gracefully", () => {
      ...
      expect(
        screen.getByText("UNKNOWN Insulation Specifications"),
      ).toBeInTheDocument();
    });
