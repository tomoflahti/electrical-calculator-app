...
const IECReferenceChartsPage: React.FC = () => {
  ...
  const [selectedInstallationMethod, setSelectedInstallationMethod] =
    useState("A1");
    ...
    <Container maxWidth="xl" sx={{ py: 4 }}>
        ...
        <Box display="flex" alignItems="center" gap={2}>
          ...
          <Box>
            ...
            <Typography variant="subtitle1" sx={{ opacity: 0.9 }}>
              International Electrical Standards (IEC 60364) - Pure Metric
              Implementation
            </Typography>
          </Box>
        </Box>
      ...
      <Alert severity="info" icon={<Info />} sx={{ mb: 3 }}>
        <Typography variant="body2">
          <strong>IEC International Standards:</strong> These charts follow IEC
          60364 electrical installation standards. All measurements are in
          metric units (mm², A, °C). Cable sizes are based on European copper
            ...
            <Grid item xs={12} md={3}>
              <FormControl fullWidth size="small">
                ...
                <Select
                  ...
                  onChange={(e) =>
                    setSelectedTemperature(e.target.value as 70 | 90)
                  }
                >
            ...
            <Grid item xs={12} md={6}>
              <FormControl fullWidth size="small">
                ...
                <Select
                  ...
                  onChange={(e) =>
                    setSelectedInstallationMethod(e.target.value)
                  }
                >
      ...
      <Card>
        ...
        <TabPanel value={tabValue} index={0}>
          ...
          <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
            Current carrying capacity (ampacity) for IEC standard cables based
            on conductor material, temperature rating, and installation method.
            All values comply with IEC 60364 standards.
          </Typography>
        ...
        <TabPanel value={tabValue} index={1}>
          ...
          <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
            ...
            from 30°C. These factors are applied to the base current carrying
            capacity.
          </Typography>
        ...
        <TabPanel value={tabValue} index={2}>
          ...
          <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
            Grouping factors for cables installed in groups. These factors
            account for mutual heating effects when multiple cables are
            installed together.
          </Typography>
        ...
        <TabPanel value={tabValue} index={3}>
          ...
          <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
            Installation method factors according to IEC 60364. Different
            installation methods have different heat dissipation
            characteristics.
          </Typography>
      ...
      <Box sx={{ mt: 4, p: 3, backgroundColor: "grey.50", borderRadius: 2 }}>
        <Typography variant="body2" color="text.secondary" align="center">
          <strong>Standards Compliance:</strong> All charts comply with IEC
          60364 electrical installation standards. Values are based on European
          conductor specifications and installation practices.
          <br />
          <strong>Temperature Base:</strong> 30°C ambient temperature |{" "}
          <strong>Soil Temperature:</strong> 20°C |{" "}
