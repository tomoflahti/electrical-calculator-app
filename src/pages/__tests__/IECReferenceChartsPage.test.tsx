...
jest.mock('../../components/charts/IECCableAmpacityChart', () => {
  return function MockIECCableAmpacityChart(props: any) {
    return (
...
describe('IECReferenceChartsPage', () => {
  describe('Page Rendering', () => {
    it('should render page header with IEC standards information', () => {
      ...
      expect(screen.getByText(/International Electrical Standards/)).toBeInTheDocument();
      expect(screen.getByText(/Pure Metric Implementation/)).toBeInTheDocument();
    });
    ...
    it('should display IEC standards information alert', () => {
      ...
      expect(screen.getByText(/IEC International Standards/)).toBeInTheDocument();
  ...
  describe('Chart Tabs', () => {
    ...
    it('should show coming soon message for unimplemented tabs', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText('Grouping Factors Chart - Coming Soon')).toBeInTheDocument();
      });
    });
  });
  ...
  describe('IEC Standards Compliance', () => {
    ...
    it('should reference IEC 60364 standards', () => {
      ...
      expect(screen.getByText(/European conductor specifications/)).toBeInTheDocument();
    });
  ...
  describe('Accessibility', () => {
    ...
    it('should have proper headings hierarchy', () => {
      ...
      expect(screen.getByRole('heading', { level: 4, name: /IEC Reference Charts/ })).toBeInTheDocument();
  ...
  describe('Error Handling', () => {
    ...
    it('should handle tab changes without errors', async () => {
      ...
      const tabs = ['Temperature Derating', 'Grouping Factors', 'Installation Methods'];
