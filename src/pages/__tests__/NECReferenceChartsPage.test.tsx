...
jest.mock("../../components/charts/NECWireAmpacityChart", () => {
  return function MockNECWireAmpacityChart(props: {
    material?: string;
...
describe("NECReferenceChartsPage", () => {
  describe("Page Rendering", () => {
    it("should render page header with NEC standards information", () => {
      ...
      expect(
        screen.getByText(/Pure Imperial Implementation/),
      ).toBeInTheDocument();
    });
    ...
    it("should display NEC standards information alert", () => {
      ...
      expect(
        screen.getAllByText(/NFPA 70 National Electrical Code/),
      ).toHaveLength(2);
  ...
  describe("Chart Tabs", () => {
    ...
    it("should display wire ampacity chart by default", () => {
      ...
      expect(
        screen.getByText("NEC Wire Current Carrying Capacity"),
      ).toBeInTheDocument();
    ...
    it("should show coming soon message for unimplemented tabs", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText("Conductor Bundling Chart - Coming Soon"),
        ).toBeInTheDocument();
      });
    });
  });
  ...
  describe("NEC Standards Compliance", () => {
    ...
    it("should reference NFPA 70 standards", () => {
      ...
      expect(
        screen.getAllByText(/American Wire Gauge specifications/),
      ).toHaveLength(2);
    });
    ...
    it("should display proper temperature specifications", () => {
      ...
      expect(
        screen.getByText(/North American installation practices/),
      ).toBeInTheDocument();
    });
    ...
    it("should reference NEC articles correctly", () => {
      ...
      waitFor(() => {
        expect(
          screen.getByText(/NEC Table 310.15\(B\)\(2\)\(a\)/),
        ).toBeInTheDocument();
      });
    });
  });
  ...
  describe("Footer Information", () => {
    ...
    it("should display temperature specifications in imperial", () => {
      ...
      expect(
        screen.getByText(/30°C \(86°F\) ambient temperature/),
      ).toBeInTheDocument();
  ...
  describe("Accessibility", () => {
    ...
    it("should have proper headings hierarchy", () => {
      ...
      expect(
        screen.getByRole("heading", { level: 4, name: /NEC Reference Charts/ }),
      ).toBeInTheDocument();
      expect(
  ...
  describe("NEC Warning Messages", () => {
    it("should display temperature derating warning", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText(
            /Temperature derating factors are critical for safety/,
          ),
        ).toBeInTheDocument();
        expect(
          screen.getByText(/ambient temperatures exceed 30°C \(86°F\)/),
        ).toBeInTheDocument();
      });
    });
    ...
    it("should display conductor bundling information", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText(/NEC Table 310.15\(B\)\(3\)\(a\)/),
        ).toBeInTheDocument();
