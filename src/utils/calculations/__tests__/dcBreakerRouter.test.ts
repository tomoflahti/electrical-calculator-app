...
describe('DC Breaker Router', () => {
  describe('Standard Routing', () => {
    ...
    it('should throw error for invalid wireStandard', () => {
      ...
      expect(() => calculateDCBreakerSize(input)).toThrow('Unsupported wire standard: INVALID');
    });
  });
  ...
  describe('Input Validation', () => {
    describe('Current Input Method', () => {
      ...
      it('should reject missing load current', () => {
        ...
        const errors = validateDCBreakerInput(input);
        expect(errors).toContain('Load current must be greater than 0 when using current input method');
      });
      ...
      it('should reject excessive load current', () => {
        ...
        const errors = validateDCBreakerInput(input);
        expect(errors).toContain('Load current exceeds maximum supported range (1000A)');
      });
    });
    ...
    describe('Power Input Method', () => {
      ...
      it('should reject missing load power', () => {
        ...
        const errors = validateDCBreakerInput(input);
        expect(errors).toContain('Load power must be greater than 0 when using power input method');
      });
      ...
      it('should reject missing system voltage', () => {
        ...
        const errors = validateDCBreakerInput(input);
        expect(errors).toContain('System voltage must be greater than 0 when using power input method');
      });
      ...
      it('should reject excessive power', () => {
        ...
        const errors = validateDCBreakerInput(input);
        expect(errors).toContain('Load power exceeds maximum supported range (100kW)');
      });
      ...
      it('should reject excessive voltage', () => {
        ...
        const errors = validateDCBreakerInput(input);
        expect(errors).toContain('System voltage exceeds maximum supported range (1000V DC)');
      });
    ...
    describe('Common Validation', () => {
      it('should reject invalid input method', () => {
        ...
        const errors = validateDCBreakerInput(input);
        expect(errors).toContain('Input method must be either "current" or "power"');
      });
      ...
      it('should reject invalid application type', () => {
        ...
        const errors = validateDCBreakerInput(input);
        expect(errors).toContain('Invalid application type. Must be one of: automotive, marine, solar, telecom, battery, led, industrial');
      });
      ...
      it('should require solar-specific inputs for solar application', () => {
        ...
        const errors = validateDCBreakerInput(input);
        expect(errors).toContain('Solar applications require either shortCircuitCurrent or panelIsc with numberOfPanels');
      });
  ...
  describe('Helper Functions', () => {
    describe('calculateSolarBreakerFromPanels', () => {
      it('should calculate parallel string breaker size with NEC factor', () => {
        const result = calculateSolarBreakerFromPanels(9.5, 2, 'parallel', 'NEC');
      ...
      it('should calculate parallel string breaker size with IEC factor', () => {
        const result = calculateSolarBreakerFromPanels(9.5, 2, 'parallel', 'IEC');
    ...
    describe('getBreakerRecommendations', () => {
      it('should return recommendations for multiple current levels', () => {
        ...
        const results = getBreakerRecommendations(currentLevels, 'automotive', 'continuous', 'IEC');
      ...
      it('should handle different duty cycles', () => {
        ...
        const results = getBreakerRecommendations(currentLevels, 'marine', 'intermittent', 'NEC');
      ...
      it('should default to IEC standard', () => {
        ...
        expect(results[0].standard).toBe('IEC60947');
      });
    });
  });
});