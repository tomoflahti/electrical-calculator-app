...
const BS7671_CABLE_SPECIFICATIONS: BS7671CableSpecification[] = [
  ...
  { size: '1.0', crossSectionMm2: 1.0, resistance: 18.1, reactance: 0.08, currentCapacity60C: 11, currentCapacity70C: 13, currentCapacity90C: 16, diameter: 5.6, weight: 45, insulationThickness: 0.6, ukStandard: 'BS 6004' },
  { size: '1.5', crossSectionMm2: 1.5, resistance: 12.1, reactance: 0.08, currentCapacity60C: 14.5, currentCapacity70C: 17.5, currentCapacity90C: 20, diameter: 6.1, weight: 58, insulationThickness: 0.7, ukStandard: 'BS 6004' },
  { size: '2.5', crossSectionMm2: 2.5, resistance: 7.41, reactance: 0.08, currentCapacity60C: 20, currentCapacity70C: 24, currentCapacity90C: 27, diameter: 6.8, weight: 78, insulationThickness: 0.8, ukStandard: 'BS 6004' },
  { size: '4', crossSectionMm2: 4.0, resistance: 4.61, reactance: 0.075, currentCapacity60C: 26, currentCapacity70C: 32, currentCapacity90C: 36, diameter: 7.5, weight: 102, insulationThickness: 0.8, ukStandard: 'BS 6004' },
  { size: '6', crossSectionMm2: 6.0, resistance: 3.08, reactance: 0.075, currentCapacity60C: 34, currentCapacity70C: 41, currentCapacity90C: 46, diameter: 8.2, weight: 130, insulationThickness: 0.8, ukStandard: 'BS 6004' },
  { size: '10', crossSectionMm2: 10.0, resistance: 1.83, reactance: 0.075, currentCapacity60C: 46, currentCapacity70C: 57, currentCapacity90C: 64, diameter: 9.5, weight: 180, insulationThickness: 1.0, ukStandard: 'BS 6004' },
  { size: '16', crossSectionMm2: 16.0, resistance: 1.15, reactance: 0.070, currentCapacity60C: 61, currentCapacity70C: 76, currentCapacity90C: 85, diameter: 10.5, weight: 240, insulationThickness: 1.0, ukStandard: 'BS 6004' },
  { size: '25', crossSectionMm2: 25.0, resistance: 0.727, reactance: 0.070, currentCapacity60C: 80, currentCapacity70C: 101, currentCapacity90C: 112, diameter: 12.2, weight: 330, insulationThickness: 1.2, ukStandard: 'BS 6004' },
  { size: '35', crossSectionMm2: 35.0, resistance: 0.524, reactance: 0.065, currentCapacity60C: 99, currentCapacity70C: 125, currentCapacity90C: 138, diameter: 13.4, weight: 430, insulationThickness: 1.2, ukStandard: 'BS 6004' },
  { size: '50', crossSectionMm2: 50.0, resistance: 0.387, reactance: 0.065, currentCapacity60C: 119, currentCapacity70C: 151, currentCapacity90C: 167, diameter: 15.0, weight: 580, insulationThickness: 1.4, ukStandard: 'BS 6004' },
  { size: '70', crossSectionMm2: 70.0, resistance: 0.268, reactance: 0.065, currentCapacity60C: 151, currentCapacity70C: 192, currentCapacity90C: 213, diameter: 17.0, weight: 770, insulationThickness: 1.4, ukStandard: 'BS 6004' },
  { size: '95', crossSectionMm2: 95.0, resistance: 0.193, reactance: 0.060, currentCapacity60C: 182, currentCapacity70C: 232, currentCapacity90C: 258, diameter: 19.2, weight: 1000, insulationThickness: 1.6, ukStandard: 'BS 6004' },
  { size: '120', crossSectionMm2: 120.0, resistance: 0.153, reactance: 0.060, currentCapacity60C: 210, currentCapacity70C: 269, currentCapacity90C: 299, diameter: 21.0, weight: 1200, insulationThickness: 1.6, ukStandard: 'BS 6004' },
  { size: '150', crossSectionMm2: 150.0, resistance: 0.124, reactance: 0.055, currentCapacity60C: 240, currentCapacity70C: 309, currentCapacity90C: 344, diameter: 22.8, weight: 1450, insulationThickness: 1.8, ukStandard: 'BS 6004' },
  { size: '185', crossSectionMm2: 185.0, resistance: 0.099, reactance: 0.055, currentCapacity60C: 273, currentCapacity70C: 353, currentCapacity90C: 392, diameter: 24.8, weight: 1750, insulationThickness: 1.8, ukStandard: 'BS 6004' },
  { size: '240', crossSectionMm2: 240.0, resistance: 0.077, reactance: 0.050, currentCapacity60C: 320, currentCapacity70C: 415, currentCapacity90C: 461, diameter: 27.3, weight: 2200, insulationThickness: 2.0, ukStandard: 'BS 6004' },
  { size: '300', crossSectionMm2: 300.0, resistance: 0.061, reactance: 0.050, currentCapacity60C: 367, currentCapacity70C: 477, currentCapacity90C: 530, diameter: 29.8, weight: 2700, insulationThickness: 2.0, ukStandard: 'BS 6004' },
  { size: '400', crossSectionMm2: 400.0, resistance: 0.047, reactance: 0.045, currentCapacity60C: 419, currentCapacity70C: 546, currentCapacity90C: 607, diameter: 33.0, weight: 3400, insulationThickness: 2.2, ukStandard: 'BS 6004' },
  { size: '500', crossSectionMm2: 500.0, resistance: 0.037, reactance: 0.045, currentCapacity60C: 467, currentCapacity70C: 609, currentCapacity90C: 677, diameter: 35.8, weight: 4100, insulationThickness: 2.2, ukStandard: 'BS 6004' },
  { size: '630', crossSectionMm2: 630.0, resistance: 0.030, reactance: 0.040, currentCapacity60C: 525, currentCapacity70C: 686, currentCapacity90C: 763, diameter: 39.5, weight: 5000, insulationThickness: 2.4, ukStandard: 'BS 6004' }
];
...
// BS7671 Installation method factors (BS7671 Appendix 4)
const BS7671_INSTALLATION_METHODS: Record<string, BS7671InstallationMethodFactor> = {
  'A1': {
    factor: 1.0,
    ...
    referenceMethod: 'A1',
    ukSpecificNotes: ['Part P notification may be required', 'Building Regulations compliance']
  },
  'A2': {
    factor: 1.0,
...
const UK_DIVERSITY_FACTORS: Record<string, number> = {
  'socket_outlets': 0.40,      // Socket outlet final circuits
  'lighting': 0.66,           // Lighting circuits
  'water_heating': 1.00,      // Water heating (no diversity)
  'space_heating': 1.00,      // Space heating (no diversity)
  'cooking': 0.10,            // Cooking appliances first 10A + 30% remainder + 5A
  'motor_loads': 1.00,        // Motor loads (no diversity)
 ...
 */
export function calculateBS7671WireSize(input: WireCalculationInput): WireCalculationResult {
  const {
    loadCurrent,
    circuitLength,
    voltage,
  ...
  if (voltage === 240) {
    warnings.push('240V is deprecated in UK. Use 230V for new installations (BS7671)');
  }
  
  // UK ambient temperature consideration
  if (ambientTemperature !== 20 && ambientTemperature !== 30) {
    assumptions.push(`Using ${ambientTemperature}°C ambient temperature (UK standard assumes 20°C)`);
  }
  ...
  if (suitableCables.length === 0) {
    throw new Error('No suitable BS7671 cable size found for the given current requirements');
  }
  ...
  const temperatureCompliant = ambientTemperature >= -10 && ambientTemperature <= 70;
  const installationCompliant = BS7671_INSTALLATION_METHODS[installationMethod] !== undefined;

  // Add UK-specific compliance checks
  if (voltage < 230 || voltage > 400) {
    warnings.push('Voltage outside standard UK range (230V single-phase, 400V three-phase)');
  }
...
function calculateBS7671CorrectionFactors({
  ...
  if (!groupingFactorValue) {
    const groupingKeys = Object.keys(BS7671_GROUPING_FACTORS).map(Number).sort((a, b) => a - b);
    ...
    if (numberOfConductors > groupingKeys[groupingKeys.length - 1]) {
      groupingFactorValue = BS7671_GROUPING_FACTORS[groupingKeys[groupingKeys.length - 1]];
    }
  }

  // Installation method factor
  const installationFactor = BS7671_INSTALLATION_METHODS[installationMethod]?.factor || 1.0;
...
function getBS7671CableCostFactor(size: string): number {
  const costFactors: Record<string, number> = {
    '1.0': 1.0, '1.5': 1.1, '2.5': 1.3, '4': 1.6, '6': 1.9, '10': 2.4,
    '16': 3.0, '25': 3.8, '35': 4.6, '50': 5.7, '70': 7.1, '95': 8.6,
    '120': 10.4, '150': 12.5, '185': 14.8, '240': 17.8, '300': 20.9,
    '400': 24.8, '500': 28.8, '630': 34.2
  };
 ...
 */
export function applyUKDiversityFactor(current: number, loadType: string): number {
 ...
 */
export function getBS7671CableData(size: string): BS7671CableSpecification | undefined {
 ...
 */
export function getBS7671InstallationMethodFactors(): Record<string, BS7671InstallationMethodFactor> {
