...
const IEC_CABLE_SPECIFICATIONS: IECCableSpecification[] = [
  ...
  },
  {
    ...
    resistance: 18.1,
    reactance: 0.08,
    currentCapacity60C: 13,
    currentCapacity70C: 16,
    currentCapacity90C: 19,
    diameter: 5.6,
    weight: 45,
    insulationThickness: 0.6,
  },
  {
    ...
    resistance: 12.1,
    reactance: 0.08,
    currentCapacity60C: 17.5,
    currentCapacity70C: 21,
    currentCapacity90C: 24,
    diameter: 6.1,
    weight: 58,
  ...
  },
  {
    ...
    resistance: 7.41,
    reactance: 0.08,
    currentCapacity60C: 24,
    currentCapacity70C: 28,
    currentCapacity90C: 32,
    diameter: 6.8,
    weight: 78,
  ...
  },
  {
    ...
    resistance: 4.61,
    reactance: 0.075,
    currentCapacity60C: 32,
    currentCapacity70C: 37,
    currentCapacity90C: 43,
    diameter: 7.5,
    weight: 102,
    insulationThickness: 0.8,
  },
  {
    ...
    resistance: 3.08,
    reactance: 0.075,
    currentCapacity60C: 41,
    currentCapacity70C: 47,
    currentCapacity90C: 54,
    diameter: 8.2,
    weight: 130,
    insulationThickness: 0.8,
  },
  {
    ...
    resistance: 1.83,
    reactance: 0.075,
    currentCapacity60C: 57,
    currentCapacity70C: 66,
    currentCapacity90C: 75,
    diameter: 9.5,
    weight: 180,
  ...
  },
  {
    ...
    resistance: 1.15,
    reactance: 0.07,
    currentCapacity60C: 76,
    currentCapacity70C: 87,
    currentCapacity90C: 100,
    diameter: 10.5,
    weight: 240,
    insulationThickness: 1.0,
  },
  {
    ...
    resistance: 0.727,
    reactance: 0.07,
    currentCapacity60C: 101,
    currentCapacity70C: 115,
    currentCapacity90C: 132,
    diameter: 12.2,
    weight: 330,
  ...
  },
  {
    ...
    resistance: 0.524,
    reactance: 0.065,
    currentCapacity60C: 125,
    currentCapacity70C: 144,
    currentCapacity90C: 165,
    diameter: 13.4,
    weight: 430,
    insulationThickness: 1.2,
  },
  {
    ...
    currentCapacity70C: 173,
    currentCapacity90C: 196,
    diameter: 15.0,
    weight: 580,
  ...
  },
  {
    ...
    resistance: 0.268,
    reactance: 0.065,
    currentCapacity60C: 192,
    currentCapacity70C: 218,
    currentCapacity90C: 246,
    diameter: 17.0,
    weight: 770,
    insulationThickness: 1.4,
  },
  {
    ...
    resistance: 0.193,
    reactance: 0.06,
    currentCapacity60C: 232,
    currentCapacity70C: 263,
    currentCapacity90C: 297,
    diameter: 19.2,
    weight: 1000,
  ...
  },
  {
    ...
    resistance: 0.153,
    reactance: 0.06,
    currentCapacity60C: 269,
    currentCapacity70C: 305,
  ...
  },
  {
    ...
    resistance: 0.124,
    reactance: 0.055,
    currentCapacity60C: 309,
    currentCapacity70C: 350,
    currentCapacity90C: 394,
    diameter: 22.8,
    weight: 1450,
  ...
  },
  {
    ...
    resistance: 0.099,
    reactance: 0.055,
    currentCapacity60C: 353,
    currentCapacity70C: 400,
    currentCapacity90C: 450,
    diameter: 24.8,
    weight: 1750,
    insulationThickness: 1.8,
  },
  {
    ...
    resistance: 0.077,
    reactance: 0.05,
    currentCapacity60C: 415,
    currentCapacity70C: 469,
    currentCapacity90C: 527,
    diameter: 27.3,
    weight: 2200,
  ...
  },
  {
    ...
    resistance: 0.061,
    reactance: 0.05,
    currentCapacity60C: 477,
    currentCapacity70C: 539,
    currentCapacity90C: 606,
    diameter: 29.8,
    weight: 2700,
    insulationThickness: 2.0,
  },
  {
    ...
    resistance: 0.047,
    reactance: 0.045,
    currentCapacity60C: 546,
    currentCapacity70C: 618,
    currentCapacity90C: 695,
    diameter: 33.0,
    weight: 3400,
  ...
  },
  {
    ...
    resistance: 0.037,
    reactance: 0.045,
    currentCapacity60C: 609,
    currentCapacity70C: 689,
    currentCapacity90C: 775,
    diameter: 35.8,
    weight: 4100,
    insulationThickness: 2.2,
  },
  {
    ...
    resistance: 0.03,
    reactance: 0.04,
    currentCapacity60C: 686,
    currentCapacity70C: 776,
    currentCapacity90C: 873,
    diameter: 39.5,
    weight: 5000,
  ...
  {
    size: "800",
    crossSectionMm2: 800.0,
    resistance: 0.023,
    reactance: 0.04,
    currentCapacity60C: 758,
    currentCapacity70C: 857,
    currentCapacity90C: 964,
    diameter: 42.8,
    weight: 6200,
    insulationThickness: 2.4,
  },
  {
    size: "1000",
    crossSectionMm2: 1000.0,
    resistance: 0.018,
    reactance: 0.035,
    currentCapacity60C: 814,
    currentCapacity70C: 920,
    currentCapacity90C: 1035,
    diameter: 45.8,
    weight: 7500,
    insulationThickness: 2.6,
  },
];
 ...
 */
export function calculateIECWireSize(
  ...
  if (suitableCables.length === 0) {
    throw new Error(
      "No suitable IEC cable size found for the given current requirements",
    );
  }
  ...
  const temperatureCompliant =
    ambientTemperature >= -40 && ambientTemperature <= 90;
  const installationCompliant =
    IEC_INSTALLATION_METHODS[installationMethod] !== undefined;
...
function calculateIECCorrectionFactors({
  ...
  if (!groupingFactorValue) {
    const groupingKeys = Object.keys(IEC_GROUPING_FACTORS)
      .map(Number)
      .sort((a, b) => a - b);
    ...
    if (numberOfConductors > groupingKeys[groupingKeys.length - 1]) {
      groupingFactorValue =
        IEC_GROUPING_FACTORS[groupingKeys[groupingKeys.length - 1]];
    }
  }

  // Installation method factor
  const installationFactor =
    IEC_INSTALLATION_METHODS[installationMethod]?.factor || 1.0;
 ...
 */
export function getIECCableData(
  size: string,
): IECCableSpecification | undefined {
 ...
 */
export function getIECInstallationMethodFactors(): Record<
  string,
  IECInstallationMethodFactor
> {
